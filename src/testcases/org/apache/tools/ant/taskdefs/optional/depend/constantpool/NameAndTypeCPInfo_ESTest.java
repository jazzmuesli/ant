...
public class NameAndTypeCPInfo_ESTest extends NameAndTypeCPInfo_ESTest_scaffolding {

  @Test(timeout = 4000)
  public void test0()  throws Throwable  {
      NameAndTypeCPInfo nameAndTypeCPInfo0 = new NameAndTypeCPInfo();
      String string0 = nameAndTypeCPInfo0.toString();
      assertEquals("Name index = 0, descriptor index = 0", string0);
  }

  @Test(timeout = 4000)
  public void test1()  throws Throwable  {
      NameAndTypeCPInfo nameAndTypeCPInfo0 = new NameAndTypeCPInfo();
      String string0 = nameAndTypeCPInfo0.getType();
      assertNull(string0);
  }
  ...
  public void test2()  throws Throwable  {
      NameAndTypeCPInfo nameAndTypeCPInfo0 = new NameAndTypeCPInfo();
      String string0 = nameAndTypeCPInfo0.getName();
      assertNull(string0);
  }
  ...
  public void test5()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        nameAndTypeCPInfo0.read(dataInputStream0);
        fail("Expecting exception: NullPointerException");
